package com.example.iii.myapplication;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       add.setOnClickListener(btnadd_click);
        ...
        ArrayAdapter<String> sweet = new ArrayAdapter<>(MainActivity.this,
                android.R.layout.simple_spinner_dropdown_item,
                sweets);
        sweetsSpinner.setAdapter(sweet);
        final String[] ice = {"正常", "八分", "五分", "三分","一分"};
        ArrayAdapter<String> temp = new ArrayAdapter<>(MainActivity.this,
                android.R.layout.simple_spinner_dropdown_item,
                ice);
